# officeroad — BlackRoad OS

**Live:** [officeroad.blackroad.io](https://officeroad.blackroad.io)
**Part of:** [BlackRoad OS](https://os.blackroad.io) — browser-based desktop with 27 AI agents

## Try It

Open [os.blackroad.io](https://os.blackroad.io) in any browser. No signup required. Click officeroad in the dock.

Or visit [officeroad.blackroad.io](https://officeroad.blackroad.io) directly.

## What It Does

officeroad is one of 17 products in BlackRoad OS, a browser-based operating system running on 5 Raspberry Pi 5 computers with Hailo-8 AI accelerators.

- **    4453 lines** of working code
